...
(function () {
  ...
  function generateRatingStarsHTML(rating) {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < full)
        stars += `<img src="${assetsPath}star-full.svg" alt="★" class="star">`;
      else if (i === full && half)
        stars += `<img src="${assetsPath}star-half.svg" alt="½" class="star">`;
      else
        stars += `<img src="${assetsPath}star-empty.svg" alt="☆" class="star">`;
    }
